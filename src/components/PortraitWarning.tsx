...
export function PortraitWarning() {
  return (
    <div id="portrait-warning-overlay" className="hidden portrait:flex fixed inset-0 z-[9999] bg-slate-950 text-slate-100 flex-col items-center justify-center text-center p-6 select-none">
      ...
      <h2 id="portrait-warning-title" className="text-sm sm:text-base font-normal tracking-wider text-white mb-2 uppercase font-title">
